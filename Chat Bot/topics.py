...
def GigResponse(text: str):
    ...
    response = giga.chat(f"Дано обращение гражданина:{text}. Сопоставь данное обращение с одним из данных заголовков: Спорт, жилично-комунальное хозяйство, материнский капитал, градо-строительная деятельность, бюджет для граждан, охрана труда, социальные сети, инвестиционная деятельность. Пиши только один заголовок и ничего лишнего! Отвечай одним словосочетанием!  ")
